...
<head>
    ...
    <title>Account verifikáció</title>
    ...
    <?php
        if(isset($_GET['account'])){
            include('szervercsatlakozas.php');
             ...
             $sql = "UPDATE loginform SET ellenorzotte = 1 WHERE username = '$account'";
             if(mysqli_query($csatlakozas, $sql)){
                echo"<script>alert('Sikeres verifikáció, $account!');window.location.href = 'login.php';</script>";
             }
        }
    ?>
</div>
